...
const seedEmails: EmailRecord[] = [
  {
    ...
    triage: {
      ...
      suggested_reply:
        "Thanks for flagging this. We are reviewing the March invoice now and will confirm whether the duplicate charge needs a refund or correction shortly.",
      confidence: 0.94,
  ...
  },
  {
    ...
    triage: {
      ...
      suggested_reply:
        "Thanks for reporting this. We have flagged it as urgent and routed it to engineering for immediate investigation. We will share an update as soon as we confirm impact and next steps.",
      confidence: 0.98,
  ...
  },
  {
    ...
    triage: {
      ...
      suggested_reply:
        "Happy to help. You can add a second admin from Workspace Settings > Members by opening the member row and updating the role to Admin. If the option is missing, we can also verify your current permissions.",
      confidence: 0.91,
      needs_human_review: false,
      reviewer_notes: "",
      approved: true,
  ...
  },
  {
    ...
    triage: {
      ...
      suggested_reply:
        "Thanks for the suggestion. We have shared the Notion export request with the product team and can keep you posted if it moves onto the roadmap.",
      confidence: 0.88,
      needs_human_review: true,
  ...
  },
  {
    ...
    triage: {
      ...
      suggested_reply:
        "Thanks for the details. We have shared the login-link issue with engineering and are checking whether expiration settings or a recent change caused the problem.",
      confidence: 0.89,
      needs_human_review: true,
      reviewer_notes: "",
      approved: false,
...
export const mockEmails: EmailRecord[] = seedEmails.map((email) => ({
  ...email,
  snippet: snippetFrom(email.body),
}));
